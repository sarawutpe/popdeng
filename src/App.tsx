  ...
  return (
    <>
      <div className="fixed inset-0 bg-cover bg-center bg-no-repeat overflow-hidden" style={{ backgroundImage: `url('/bg-min.jpg')` }}>
        <div onMouseDown={handleMouseDown} onMouseUp={handleMouseUp} style={{ touchAction: "manipulation" }}>
          <div className="flex justify-center items-center p-4">
            <h1 className="brand-text text-6xl font-bold relative inline-block">
              ...
              <span className="absolute inset-0 text-white pointer-events-none" style={{ WebkitTextStroke: "7px white" }}>
                POPDENG
              </span>
            </h1>
          </div>
          ...
          <div className="flex flex-col justify-center items-center h-[calc(100vh-8rem)]">
            <img className="select-none" src={moodengImg} alt="moodeng" draggable="false" />
          </div>
        </div>
      </div>
    </>
